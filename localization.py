...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "label.pulley_blocked_at": "Pulley is blocked at:",
        "label.pulley_blocked_note": "... of speed system <b>line</b> (not pulleys) range",
        "combo.speed_system_type_1_stage": "One step (?)",
        "combo.speed_system_type_2_stage": "Two step (?)",
        "tooltip.speed_system_type_1_stage": "Speed system has 1 pulley (B-C bridge don't count). Or speed system has 2 pulleys and:\nthe line pulls pulleys of speed system at same rate over entire range, until they touch..",
        "tooltip.speed_system_type_2_stage": "Speed system has 2 pulleys (B-C bridge don't count) and:\n in the end of the range one of the pulleys is locked out. This turns 2-pulley system into 1-pulley system. And makes further pull 50% harder and 50% faster.",
    },
    "russian": {
        ...
        "label.pulley_blocked_at": "Блочек блокируется на:",
        "label.pulley_blocked_note": "... от общего диапазона <b>шнура</b> (не блочков) акселя",
        "combo.speed_system_type_1_stage": "Одна ступень (?)",
        "combo.speed_system_type_2_stage": "Две ступени (?)",
        "tooltip.speed_system_type_1_stage": "У крыла 1 блочок (B-C мост не считается) или у крыла 2 блочка и: \nШнур стягивает блочки с одинаковой скоростью во всем диапазоне, пока они не соприкоснутся..",
        "tooltip.speed_system_type_2_stage": "У крыла 2 блочка (B-C мост не считается) и:\nВ конце диапазона один из блочков блокируется. Это превращает систему из 2х блоков в систему из 1 блока. Что делает дальнейшее стягивание на 50% тяжелее и на 50% быстрее.",
    },
}
