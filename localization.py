...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "ru": {
        ...
        "tab.optimal_pedal": "Оптимальная ступень акселя",
        ...
        "chart.optimal_pedal.axis_x": "Глайд",
        "chart.optimal_pedal.axis_y": "Оптимальная ступень акселя",
        "chart.optimal_pedal.title": "Оптимальная ступень акселя",
